...
- We print out an optimal set of robot actions at the end of the fill_qmatrix function. These are calculated from the q-matrix, so by subscribing to the q_matrix topic in later scripts, we can recalculate these in the movement and perception functions. 
...
- ![MoveLiftSet (1)](https://user-images.githubusercontent.com/68019178/109747746-53be6280-7b9d-11eb-8365-62978ad3171f.gif)
